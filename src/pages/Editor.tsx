          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="glass rounded-2xl p-5">
                <label className="block text-xs font-medium text-muted-foreground mb-3">Cover Image</label>
                <div className="relative rounded-xl border border-dashed border-border p-6 text-center text-sm text-muted-foreground hover:border-muted-foreground/30 hover:bg-muted/10 transition-all cursor-pointer">
              ...
              <div className="glass rounded-2xl p-5">
                <label className="block text-xs font-medium text-muted-foreground mb-3">Audio</label>
                <div className="relative rounded-xl border border-dashed border-border p-6 text-center text-sm text-muted-foreground hover:border-muted-foreground/30 hover:bg-muted/10 transition-all cursor-pointer">
